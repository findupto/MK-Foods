(() => {
  ...
  window.mkFoods={
    ...
    saveProduct:p=>safe('save_product',{p}),deleteProduct:id=>safe('delete_product',{id}),replaceProducts:p=>safe('replace_products',{products:p}),updateSettings:s=>safe('update_settings',{settings:s}),audit:e=>safe('add_audit',{e}),discoverPrinters:()=>safe('discover_printers'),connectPrinter:name=>safe('connect_printer',{name}),
